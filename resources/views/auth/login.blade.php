...
<body>
    <div class="container col-md-4 offset-md-4">
        ...
        <div class="card shadow mb-5 rounded border border-light mt-5">
            <div class="card-body rounded" style="background-color: rgb(207, 28, 198)
            " id="card-bodyy">
                <h2 class="text-center mb-4" style="color:white; font-size: 25px;"></h2>
                <h1 class="text-center text-white">Welcome to my Final Project</h1>
                ...
                <form action="{{ '/' }}" method="POST">
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <a href="{{ '/register' }}" class="text-white">Register account</a>
                        </div>
